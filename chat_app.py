...
st.set_page_config(page_title="Your AI Mate!")

st.header("Your AI Mate!")
system_prompt = st.text_area(
    label="System Prompt",
    value="You are a knowledgeable and informative AI assistant capable of providing summaries of factual topics or creating stories. Respond in a comprehensive and informative manner, using clear and concise language.",
    key="system_prompt"
)
